...
\vspace{3cm}
\title{Toy Car Control Using Esp32 and Mobile(BLE)}
\maketitle
\newpage
\bigskip
...
\begin{abstract}
This document shows how to implement Mobile(BLE) controlled toy car using Esp32.
\end{abstract}
...
\begin{enumerate}
    ...
    \item Dabble app(Download from playstore) 
    \item Breadboard
...
\begin{enumerate}
   \item Refer the pin diagram of L293D motor driver IC
    \begin{lstlisting}
Esp32/IDE/Toycar_with_Mobile/Figures/pin.jpg
    \end{lstlisting}
    \item  Connect Vcc1 pin to Vin pin  on Esp32.
    \item  The input and enable pins(ENA, IN1, IN2, IN3, IN4 and ENB) of the L293D IC are connected to six Esp32 digital output pins(14, 16, 17, 18, 19 and 15).
    ...
    \begin{lstlisting}
Esp32/IDE/Toycar_with_Mobile/Figures/wiring.jpg
    \end{lstlisting}
    \item Go to ardunio IDE and Write the the following code

\begin{lstlisting}
Esp32/IDE/Toycar_with_Mobile/Codes
\end{lstlisting}
    \item Click on Compile and Upload the code to "DOIT ESP32 DEVKITV1".
    \item Now open Dabble app search for bluetooth devices and Select "MyEsp32" and connect it.
    \item After connecting click on GamePad Icon and you will get control panel.    
